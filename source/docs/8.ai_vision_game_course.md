...
(1) Open any program in the path of the **"8. AI Vision Game Course"**. Take **"[8.5 Color Sorting](#anchor_8_5)"** as an example.
...
[hw_esp32cam_ctl.cpp](../_static/source_code/hw_esp32cam_ctl.zip)
...
To download the firmware, please refer to "[**8.4.2 Image Postback Firmware Flashing (Optional)**](#anchor_8_4_2)" in this section.
...
<img class="common_img" src="../_static/media/chapter_8/section_4/media/image3.png"  style="width:350px;" />

<img class="common_img" src="../_static/media/chapter_8/section_4/media/image4.png" style="width:350px;"  />
...
(4) Open the serial port utility tool in the path of "[**Appendix/Serial Port Utility**](https://docs.hiwonder.com/projects/uHand_UNO/en/latest/docs/resources_download.html) ".
...
<img class="common_img" src="../_static/media/chapter_8/section_4/media/image12.png"  style="width:350px;" />

(8) In the browser's research bar, enter the IP address of the camera **"192.168.197.226"** to to access the feedback interface.
...
(1) Open the "**flash_download_tool_3.9.7**" file in the "[**Appendix\Firmware Flashing Tool**](https://docs.hiwonder.com/projects/uHand_UNO/en/latest/docs/resources_download.html) ".
...
[ESP32S3-Cam Color Recognition Program](../_static/source_code/ColorDetection.zip)

[uHand UNO Color Sorting Program](../_static/source_code/uhand_colors_clamp_esp32cam.zip)
...
(1) Locate and find [uhand_colors_clamp_esp32cam/uhand_colors_ clamp_esp32cam.ino](../_static/source_code/uhand_colors_clamp_esp32cam.zip) program file in the same dictionary as this section.
...
<img class="common_img" src="../_static/media/chapter_8/section_5/media/image10.png" style="width:556px;" />

<p id="anchor_8_5_3_2"></p>

* **ESP32S3-Cam Program Download**

(1) Connect the ESP32S3-Cam to the computer with a Type-C data cable.

(2) Locate and open the [ColorDetection/ColorDetection.ino](../_static/source_code/ColorDetection.zip) program file in the same directory as this section.
...
<img class="common_img" src="../_static/media/chapter_8/section_5/media/image12.png" style="width:570px;" />

(4) Click the **"Tool"** in the menu bar, and select the corresponding configuration for the ESP32S3 development board.

<img class="common_img" src="../_static/media/chapter_8/section_5/media/image13.png"  style="width:570px;" />
...
<img class="common_img" src="../_static/media/chapter_8/section_5/media/image10.png" style="width:570px;" />
...
<img class="common_img" src="../_static/media/chapter_8/section_5/media/image47.png" style="width:100%;" />

<img class="common_img" src="../_static/media/chapter_8/section_5/media/image48.png" style="width:100%;" />

(4) Save the HSV threshold. Locate and open the "[**ESP32S3-Cam Color Recognition Program/ColorDetection/color_detection.cpp**](../_static/source_code/color_detection.zip)" file. Modify the color data to the saved HSV array. Next, refer to "[**8.5.3 Program download -> ESP32S3-Cam Program Download**](#anchor_8_5_3_2) " to flash the modified program into ESP32S3-Cam.
...
[uHand UNO Color Tracking Program](../_static/source_code/uhand_colors_trace_esp32cam.zip)
...
(1) Locate and open [**uhand_colors_trace_esp32cam/uhand_colors_ trace_esp32cam.ino**](../_static/source_code/uhand_colors_trace_esp32cam.zip)  program file in the same directory of this section.
...
<img class="common_img" src="../_static/media/chapter_8/section_6/media/image10.png" style="width:556px;" />
...
<img class="common_img" src="../_static/media/chapter_8/section_6/media/image12.png" style="width:570px;" />

(4) Click the **"Tool"** in the menu bar, and select the corresponding configuration for the ESP32S3 development board.

<img class="common_img" src="../_static/media/chapter_8/section_6/media/image13.png" style="width:570px;"  />
...
<img class="common_img" src="../_static/media/chapter_8/section_6/media/image10.png" style="width:570px;"/>
...
Import the required libraries for RGB control, servo control, buzzer tone control and the ESP32Cam library files for the game.
...
(1) Locate and open the "[**uHand UNO Color Tracking program/uhand_colors_trace_esp32cam/uhand_colors_trace_esp32cam**](../_static/source_code/uhand_colors_trace_esp32cam.zip)" program file in the same path as this lesson.
...
(3) Refer to the "**[3. Default Program Download Instruction](https://docs.hiwonder.com/projects/uHand_UNO/en/latest/docs/3.Default_Program_Download.html)**" to flash the program into the development board. Once the flashing is completed, uHand UNO can track the red object.
...
[ESP32S3-Cam Face Detection Program](../_static/source_code/FaceDetection.zip)

[uHand UNO Face Detection Program](../_static/source_code/uhand_face_esp32cam.zip)
...
(1) Locate and open the [uhand_face_esp32cam/uhand_face_ esp32cam. ino](../_static/source_code/uhand_face_esp32cam.zip) program file in the same directory as this section.
...
<img class="common_img" src="../_static/media/chapter_8/section_7/media/image10.png" style="width:556px;" />

* **ESP32S3-Cam Firmware Burning**

(1) Connect the ESP32S3-Cam to the computer with a Type-C data cable.

(2) Locate and open the [**ESP32S3-Cam Face Detection Program/FaceDetection/FaceDetection.ino**](../_static/source_code/FaceDetection.zip) program file .

<img class="common_img" src="../_static/media/chapter_8/section_7/media/image11.png"  />

(3) Select the **"ESP32S3 Dev Module"** development board.

<img class="common_img" src="../_static/media/chapter_8/section_7/media/image12.png" style="width:570px;" />

(4) Click the **"Tool"** in the menu bar, and select the corresponding configuration for the ESP32S3 development board.

<img class="common_img" src="../_static/media/chapter_8/section_7/media/image13.png" style="width:570px;"  />

(5) Click <img src="../_static/media/chapter_8/section_7/media/image8.png"  /> to download the program to the ESP32S3-Cam, and then wait for the download to complete.

<img class="common_img" src="../_static/media/chapter_8/section_7/media/image12.png" style="width:570px;" />

<img class="common_img" src="../_static/media/chapter_8/section_7/media/image10.png" style="width:570px;" />
