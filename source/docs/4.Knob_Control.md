...
<table  class="docutils-nobg" style="margin:0 auto" border="1">
    ...
    <tr>
        ...
        <td rowspan="5">Turn the knob counterclockwise to close the finger, turn the knob clockwise to open the finger.</td>
    </tr>
    <tr>
        <td>S2</td>
    ...
    <tr>
        <td>S5</td>
        <td>No. 5 Servo (Pinky)</td>
    </tr>
    <tr>
        <td>S6</td>
        <td>No. 6 Servo (Pan-Tilt)</td>
