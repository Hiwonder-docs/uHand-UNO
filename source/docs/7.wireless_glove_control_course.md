...
<table style="text-align:center">
    ...
    <tr>
        ...
        <td><img src="../_static/media/uhand uno-7/7-11.png" alt="7-11" style="height:200px"/></td>
        <td>右转</td>
    </tr>
    <tr>
    	<td>中指伸出、无名指弯曲，手掌左倾</td>
        <td><img src="../_static/media/uhand uno-7/7-12.png" alt="7-12" style="height:200px"/></td>
        <td>左转</td>
    </tr>
    <tr>
    	<td>手心朝下，握拳</td>
        <td><img src="../_static/media/uhand uno-7/7-13.png" alt="7-13" style="height:200px"/></td>
        <td>停止</td>
    </tr>
    <tr>
    	<td>手心朝下，张开手（中指伸直）</td>
        <td><img src="../_static/media/uhand uno-7/7-14.png" alt="7-14" style="height:200px"/></td>
        <td>前进</td>
    </tr>
    <tr>
    	<td>手心朝上， 中指弯曲，小拇指伸直（蜘蛛侠动作）</td>
        <td><img src="../_static/media/uhand uno-7/7-15.png" alt="7-15" style="height:200px"/></td>
        <td>后退</td>
    </tr>
    <tr>
    	<td>手心朝上，张开手</td>
        <td><img src="../_static/media/uhand uno-7/7-16.png" alt="7-16" style="height:200px"/></td>
        <td>停止</td>
    </tr>
</table>
    ...
    <tr>
     ...
     <tr>
    	...
    	<td>手腕上抬，即伸出的两指是指向前上方的。</td>
         <td><img src="../_static/media/uhand uno-7/7-17.png" alt="7-17" style="height:200px"/></td>
    	<td>前进</td>
    </tr>
     <tr>
    	<td>手腕下弯，即伸出的两指是指向前下方的。</td>
        <td><img src="../_static/media/uhand uno-7/7-18.png" alt="7-18" style="height:200px"/></td>
        <td>后退</td>
    </tr>
     <tr>
    	<td>手腕顺时针旋转，即手心朝向正左方。</td>
        <td><img src="../_static/media/uhand uno-7/7-19.png" alt="7-19" style="height:200px"/></td>
        <td>原地顺时针转动</td>
    </tr>
     <tr>
    	<td>手腕逆时针旋转，即手心朝向正右方。</td>
        <td><img src="../_static/media/uhand uno-7/7-20.png" alt="7-20" style="height:200px"/></td>
        <td>原地逆时针转动</td>
    </tr>
     <tr>
...
<table style="text-align:center">
	...
	<tr>
		...
		<td><img src="../_static/media/uhand uno-7/7-21.png" alt="7-21" style="height:200px"/></td>
		<td>云台舵机逆时针旋转（以手掌为第一视角）</td>
	</tr>
	<tr>
		<td>手心向下，五指伸直，手腕逆时针旋转</td>
		<td><img src="../_static/media/uhand uno-7/7-22.png" alt="7-22" style="height:200px"/></td>
...
<table style="text-align:center">
	...
	<tr>
		...
		<td><img src="../_static/media/uhand uno-7/7-23.png" alt="7-23" style="height:200px"/></td>
		<td>1号舵机</td>
	</tr>
	<tr>
		<td>掌向下，伸出食指和中指，左倾或右倾</td>
		<td><img src="../_static/media/uhand uno-7/7-24.png" alt="7-24" style="height:200px"/></td>
		<td>2号舵机</td>
	</tr>
	<tr>
		<td>手掌向下，伸出中指、无名指、小拇指，左倾或右倾</td>
		<td><img src="../_static/media/uhand uno-7/7-25.png" alt="7-25" style="height:200px"/></td>
		<td>3号舵机</td>
	</tr>
	<tr>
		<td>手掌向下，伸出四指，左倾或右倾</td>
		<td><img src="../_static/media/uhand uno-7/7-26.png" alt="7-26" style="height:200px"/></td>
		<td>4号舵机</td>
	</tr>
	<tr>
		<td>手掌向下，伸出五指，左倾或右倾</td>
		<td><img src="../_static/media/uhand uno-7/7-27.png" alt="7-27" style="height:200px"/></td>
		<td>5号舵机</td>
	</tr>
	<tr>
		<td>手掌向下，握拳，左倾或右倾</td>
		<td><img src="../_static/media/uhand uno-7/7-28.png" alt="7-28" style="height:200px"/></td>
		<td>6号舵机</td>
	</tr>
</table>
...
2. 根据**“[体感手套佩戴教学](#gloves-teaching)”**课程，将体感手套佩戴好。
...
3. 根据“**1.教程资料\\7.体感手套控制课程（需另购）\\2.体感手套介绍与连接**”课程，将体感手套与机械手掌进行连接。
