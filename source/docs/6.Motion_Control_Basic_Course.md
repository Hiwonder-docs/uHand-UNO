...
(3) Select [read_uhand.ino]() program and click **"Open"**.
...
(1) Keep the Type-B cable connected to the computer. Do not unplug it, as it will hinder communication. Power on the robotic hand. Then click <img class="common_img" src="../_static/media/chapter_6/section_1/media/image11.png"  /> in the upper right corner and select a baud rate of **"115200"**.
...
<img src="../_static/media/chapter_6/section_1/media/image12.png"  /><img src="../_static/media/chapter_6/section_1/media/image13.png"  />
...
Open the "uhand_actions.ino" file located in the same directory. Modify the "action_index" variable representing the action number to the corresponding number of the newly added action.
...
(3) Access "6.1.3 Action Running Program". Select "uhand_actions.ino" program in "uhand_actions" folder and click "Open".
...
After the uHand UNO is powered on, the action obtained in "[6.1.1 Read Action Data]()" will be executed.
...
(3) Access "[6.2.2 Read Action Data Program]()". Select [read_uhand.ino]() and click "Open".
...
<img class="common_img" src="../_static/media/chapter_6/section_2/media/image12.png"  /><img class="common_img" src="../_static/media/chapter_6/section_2/media/image13.png"  /><img class="common_img" src="../_static/media/chapter_6/section_2/media/image14.png"   />
...
(3) After adding the action group data, please refer to "Basic Program Download" to download the "[uhand_actions.ino]()" program to the Arduino UNO controller board.
