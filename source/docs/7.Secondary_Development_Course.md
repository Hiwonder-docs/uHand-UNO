...
<table>
  ...
  <tbody>
    <tr>
      <td>Neutral position (white light is steady on)</td>
      <td>Automatically enter the mode after powered on. Simultaneously hold down "<strong>K1, K2</strong>" to exit.</td>
      <td>ID1-6 servos are at 90 ° position.</td>
    </tr>
    <tr>
      <td rowspan="3">Normal mode (green light is steady on)</td>
      <td>Long press the red "<strong>K1</strong>".</td>
      <td>Enter the editing action group mode to clear the original action group.</td>
    </tr>
    <tr>
      <td>Short press the yellow "<strong>K2</strong>".</td>
      <td>Enter the running action group mode to run the saved action group once.</td>
    </tr>
    <tr>
      <td>Long press the yellow "<strong>K2</strong>".</td>
    ...
    <tr>
      ...
      <td>Short press the red "<strong>K1</strong>".</td>
      <td>Save action.</td>
    </tr>
    <tr>
      <td>Long press the red "<strong>K1</strong>".</td>
